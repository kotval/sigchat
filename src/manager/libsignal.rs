...
impl PrimaryProvisioningCipher {
    pub fn new(_stub: Option<String>) -> PrimaryProvisioningCipher { PrimaryProvisioningCipher {} }
    ...
    pub fn decrypt(&self, _temp_identity: IdentityKeyPair, bytes: Vec<u8>) -> ProvisionMessage {
        ...
        ProvisionMessage {
            ...
            aci: IdentityKeyPair {
                ...
                djb_identity_key: IdentityKey { key: "STUB".to_string() },
                djb_private_key: IdentityKey { key: "STUB".to_string() },
            },
            pni: IdentityKeyPair {
                service_id: "STUB".to_string(),
                djb_identity_key: IdentityKey { key: "STUB".to_string() },
...
impl IdentityKey {
    pub fn new(key: String) -> Self { IdentityKey { key } }

    pub fn clone(&self) -> IdentityKey { IdentityKey::new(self.key.clone()) }
}
...
impl DjbKeyPair {
    pub fn get_private_key(&self) -> IdentityKey { self.djb_private_key.clone() }

    pub fn get_public_key(&self) -> IdentityKey { self.djb_public_key.clone() }
}
...
pub fn generate_identity_key_pair() -> IdentityKeyPair {
    ...
    IdentityKeyPair { service_id: "STUB".to_string(), djb_identity_key, djb_private_key }
}
